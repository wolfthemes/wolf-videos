 ...
 * Main Plugin Class
 *
 * Contains the main functions for Videos
 *
 * @since 1.0.0
 */
class Plugin {
	...
	private function define_constants() {
		...
		$constants = array(
			...
			'WV_SLUG' => plugin_basename( dirname( WV_PLUGIN_FILE ) ),
			'WV_PATH' => plugin_basename( WV_PLUGIN_FILE ),
			'WV_VERSION' => $this->version,
			'WV_SUPPORT_URL' => $this->support_url,
			'WV_DOC_URI' => 'https://docs.wolfthemes.com/documentation/plugins/' . plugin_basename( dirname( WV_PLUGIN_FILE ) ),
	...
	public function includes() {
		 ...
		 */
		include_once WV_DIR . '/inc/wv-core-functions.php';
		...
		if ( $this->is_request( 'frontend' ) ) {
			include_once WV_DIR . '/inc/frontend/wv-functions.php';
			include_once WV_DIR . '/inc/frontend/wv-template-hooks.php';
	...
	public function include_template_functions() {
		include_once WV_DIR . '/inc/frontend/wv-template-functions.php';
	}
	...
	public function register_post_type() {
		include_once WV_DIR . '/inc/wv-register-post-type.php';
	}
	...
	public function register_taxonomy() {
		include_once WV_DIR . '/inc/wv-register-taxonomy.php';
	}
	...
	public function load_plugin_textdomain() {
		...
		load_plugin_textdomain( $domain, FALSE, dirname( plugin_basename( WV_PLUGIN_FILE ) ) . '/languages/' );
	}
	...
	public function plugin_url() {
		return untrailingslashit( plugins_url( '/', WV_PLUGIN_FILE ) );
	}
	...
	public function plugin_path() {
		return untrailingslashit( plugin_dir_path( WV_PLUGIN_FILE ) );
	}
	...
	public function plugin_update() {
		...
		if ( ! class_exists( 'WP_GitHub_Updater' ) ) {
			include_once WV_DIR . '/inc/admin/updater.php';
		}

		$repo = 'wolfthemes/wolf-videos';

		$config = array(
			'slug' => plugin_basename( WV_PLUGIN_FILE ),
