...
$labels = array(
	...
	'singular_name' => esc_html__( 'Videos Type', '%TEXTDOMAIN%' ),
	...
	'parent_item' => esc_html__( 'Parent Videos Type', '%TEXTDOMAIN%' ),
	'parent_item_colon' => esc_html__( 'Parent Videos Type:', '%TEXTDOMAIN%' ),
	'edit_item' => esc_html__( 'Edit Videos Type', '%TEXTDOMAIN%' ),
	'update_item' => esc_html__( 'Update Videos Type', '%TEXTDOMAIN%' ),
	'add_new_item' => esc_html__( 'Add New Videos Type', '%TEXTDOMAIN%' ),
	'new_item_name' => esc_html__( 'New Videos Type', '%TEXTDOMAIN%' ),
